...
def write_line(file_object, line, regex):
    ...
    # If match != None
    if match_object:
        output = r'\section{\large ' + match_object.group(2) + match_object.group(3) + '}\n'
    else:
        output = line
...
def write_header(title, file_object):
    ...
    message = r'\noindent' + '\n' + r'The lectures are available at https://oyc.yale.edu/english/engl-300.' + \
            r'\\Generated by Mateusz Wasilewski, using Yale transcripts. \\'+ 'Repository available at ' + r'https://github.com/santiagonasar/Yale-MOOC-transcript-pdf-generator' + '\n' 

    a = "\documentclass[12pt]{article}\n\\setcounter{secnumdepth}{0}\n\n\\begin{document}\n\n\\title{\n Introduction to Theory of Literature\\\ \n\\begin{large}" + title
    a = a + "\\end{large} }\n\n\\maketitle\n\n{\\large \\tableofcontents}\n\n"
    a = a + r'\vspace*{\fill}' + message + '\\pagebreak\n'
